...
export default function Hero() {
  return (
    <section className="mb-[160px] w-full px-4 pt-14 md:mb-[247px] md:px-0 md:pt-16 lg:mb-0 lg:min-h-[calc(100vh_-_20px)] lg:pt-40">
      <div className="flex w-full gap-16">
        <div className="z-10 flex flex-col items-center text-center md:basis-1/2 md:items-start md:text-start">
          ...
          <div className="space-x-4 text-primary-500 md:space-x-6 lg:space-x-8 lg:text-lg">
            <button
              className="rounded bg-primary-100 px-4 py-1 transition-colors hover:bg-primary-500
